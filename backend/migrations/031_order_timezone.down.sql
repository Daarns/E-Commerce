...
ALTER TABLE orders
    ...
    ALTER COLUMN snap_token_created_at TYPE TIMESTAMP USING snap_token_created_at AT TIME ZONE 'Asia/Jakarta',
    ALTER COLUMN payment_expires_at TYPE TIMESTAMP USING payment_expires_at AT TIME ZONE 'Asia/Jakarta',
    ALTER COLUMN shipped_at TYPE TIMESTAMP USING shipped_at AT TIME ZONE 'Asia/Jakarta',
    ALTER COLUMN delivered_at TYPE TIMESTAMP USING delivered_at AT TIME ZONE 'Asia/Jakarta',
...
ALTER TABLE order_status_workflows
    ALTER COLUMN created_at TYPE TIMESTAMP USING created_at AT TIME ZONE 'Asia/Jakarta',
    ALTER COLUMN updated_at TYPE TIMESTAMP USING updated_at AT TIME ZONE 'Asia/Jakarta',
    ALTER COLUMN triggered_at TYPE TIMESTAMP USING triggered_at AT TIME ZONE 'Asia/Jakarta';
